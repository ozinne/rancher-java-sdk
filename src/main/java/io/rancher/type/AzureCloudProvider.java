...
public class AzureCloudProvider extends AbstractType {
    ...
    private Password aadClientCertPassword;
    
    private String aadClientCertPath;
    
    private String aadClientId;
    
    private Password aadClientSecret;
    ...
    public Password getAadClientCertPassword() {
        return this.aadClientCertPassword;
    }

    public void setAadClientCertPassword(Password aadClientCertPassword) {
    ...
    public Password getAadClientSecret() {
        return this.aadClientSecret;
    }

    public void setAadClientSecret(Password aadClientSecret) {
